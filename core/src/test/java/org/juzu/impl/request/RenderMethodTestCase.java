...
public class RenderMethodTestCase extends TestCase {
	...
	public void testNoArg() throws Exception {
		...
		assertEquals(Collections.emptyList(), cm.getAnnotationParameters());
	...
	public void testBindingOneArg() throws Exception {
		...
		assertEquals(Arrays.<ControllerParameter>asList(new ControllerParameter("foo", "foo_value")), cm.getAnnotationParameters());
		assertEquals(Arrays.<ControllerParameter>asList(new ControllerParameter("bar")), cm.getArgumentParameters());
	}
}
