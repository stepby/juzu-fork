...
public class MockClient
{
   ...
   private MockRequestBridge create(String url)
   {
	...
	public void setFlashValue(Object key, Object value) {
		if(flash == null) flash = new HashMap<Object, Object>();
		flash.put(key, value);
	}
	...
	public Map<Object, Object> getFlash(int index) {
		if(index < 0) throw new IndexOutOfBoundsException("Wrong index " + index);
		else if (index == 0) return flash;
		else return flashHistory.get(index - 1);
	}
